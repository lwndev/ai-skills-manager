...
const CHECK_NAMES: Record<ValidationCheckName, string> = {
  ...
  permissionModeFormat: 'Permission mode format',
  disallowedToolsFormat: 'Disallowed tools format',
  argumentHintFormat: 'Argument hint format',
  keepCodingInstructionsFormat: 'Keep coding instructions format',
  toolsFormat: 'Tools format',
  colorFormat: 'Color format',
  disableModelInvocationFormat: 'Disable model invocation format',
  versionFormat: 'Version format',
  allowedToolsFormat: 'Allowed tools format',
