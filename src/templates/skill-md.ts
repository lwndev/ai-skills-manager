...
export interface TemplateOptions {
  ...
  argumentHint?: string;
  /** License for the skill (agentskills.io spec) */
  license?: string;
  /** Compatibility information (agentskills.io spec) */
  compatibility?: string;
  /** Arbitrary metadata key-value pairs (agentskills.io spec) */
...
- compatibility: Compatibility constraint (e.g., "claude-code>=2.1")
...
- compatibility: (optional) Compatibility constraint (e.g., "claude-code>=2.1")
